...
def search_by(request):
    ...
    paginator = Paginator(employees, 1) # Show 2 contacts per page.
...
def employee(request, employee_id):
	print('employee call ++++++++++++++')
	print('emloyee_id ', employee_id)
	if request.method == "GET":
		print('employee_id GET call')
...
def add_employee(request):
	print('add_empoyee call ++++++++++++++')
	if request.method == "GET":
		print('add_empoyee GET call')
